...
export default function Dietician() {
  const [form, setForm] = useState({ name: "Shrijit", age: 20, gender: "male", height_cm: 180, weight_kg: 90, goal: "maintain", activity_level: "moderate", dietary_preference: "vegetarian", allergies: [] });
