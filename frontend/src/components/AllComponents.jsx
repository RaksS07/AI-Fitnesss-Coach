...
export function HabitTracker() {
  const [form, setForm] = useState({ user_id: "user1", name: "Shrijit", workout_days: ["Monday","Wednesday","Friday"], preferred_time: "morning", streak_days: 5, total_workouts: 22, missed_last_week: 1, stress_level: 4, sleep_hours: 7, motivation_style: "data" });
  const [result, setResult] = useState(null);
